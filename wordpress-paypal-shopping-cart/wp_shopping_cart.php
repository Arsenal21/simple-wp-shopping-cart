...
function wspsc_front_side_enqueue_scripts() {
	...
	wp_register_script( "wspsc-checkout-stripe", WP_CART_URL . "/assets/js/wspsc-checkout-stripe.js", array( "jquery", "wspsc.stripe", "wp-i18n" ), WP_CART_VERSION);
	wp_register_script( "wspsc-checkout-paypal-standard", WP_CART_URL . "/assets/js/wspsc-checkout-paypal-standard.js", array('wp-i18n'), WP_CART_VERSION);
}
